package com.alex.witAg.ui.test.jna;
...
public interface HCNetSDKByJNA extends Library {
	...
	//public static class NET_DVR_NTPPARA extends Structure {
		...
		public static class NET_DVR_PLAN_TEMPLATE extends Structure {
		    ...
		    public int dwWeekPlanNo; //�ܼƻ���ţ�0Ϊ��Ч
	...
	boolean NET_DVR_GetDeviceConfig(int lUserID, int dwCommand, int dwCount, Pointer lpInBuffer, int dwInBufferSize,
                                    Pointer lpStatusList, Pointer lpOutBuffer, int dwOutBuggerSize);
	...
	int NET_DVR_StartRemoteConfig(int lUserID, int dwCommand, Pointer lpInBuffer, int dwInBufferLen, fRemoteConfigCallback
            cbStateCallback, Pointer pUserData);
	...
	int NET_DVR_UploadFile_V40(int lUserID, int dwUploadType, Pointer lpInBuffer, int dwInBufferLen, String sFileName,
                               Pointer lpOutBuffer, int dwOutBufferLen);
...
//	 boolean  NET_DVR_StopRealPlay(int lRealHandle);
	...
	public interface FMSGCallBack extends Callback {
		void invoke(int lCommand, com.hikvision.netsdk.NET_DVR_ALARMER pAlarmer,
