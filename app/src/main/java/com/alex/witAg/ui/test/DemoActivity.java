...
//
//                accessToken = m_retUrl.substring(m_retUrl.indexOf("access_token") + 13, m_retUrl.indexOf("access_token") +
//                        77);
...
//                    if (HCNetSDKJNAInstance.getInstance().NET_DVR_CapturePictureBlock(m_iPlayID, "/sdcard/capblock.jpg",
//                            0)) {
...
//                //                Player.MPInteger stSize = new Player.MPInteg
//                //            	if(m_iPlaybackID < 0){
//                //            		Log.e(TAG, "please start preview first");
//                //            		return;
//                //            	}
//                //            	else{
//                //            		if(HCNetSDKJNAInstance.getInstance().NET_DVR_PlayBackCaptureFile(m_iPlaybackID,
//                // "/sdcard/capfile.bmp")){
//                //                     	Log.e(TAG, "NET_DVR_PlayBackCaptureFile succ");
//                //                     }else{
//                //                    	 Log.e(TAG, "NET_DVR_PlayBackCaptureFile fail " + HCNetSDK.getInstance()
//                // .NET_DVR_GetLastError());
//                //                     }
//                //            	}
//
...
//
//
//                    //     m_iPlaybackID = HCNetSDK.getInstance().NET_DVR_PlayBackReverseByTime_V40(m_iLogID, playView[0]
//                    // .getHolder().getSurface(), playcond);
//
//
...
//                        if (!HCNetSDK.getInstance().NET_DVR_PlayBackControl_V40(m_iPlaybackID, PlaybackControlCommand
//                                .NET_DVR_PLAYSTART, null, 0, null)) {
...
//
//                        //     if(HCNetSDK.getInstance().NET_DVR_PlayBackControl_V40(m_iPlaybackID, PlaybackControlCommand
//                        // .NET_DVR_PLAYPAUSE, null, 0, struPlaybackInfo))
//                        //     {
//                        //    	 Log.e(TAG, "NET_DVR_PlayBackControl_V40 pause succ");
//                        //     }
//                        //
//                        //     if(HCNetSDK.getInstance().NET_DVR_PlayBackControl_V40(m_iPlaybackID, PlaybackControlCommand
//                        // .NET_DVR_PLAYRESTART, null, 0, struPlaybackInfo))
//                        //     {
//                        //    	 Log.e(TAG, "NET_DVR_PLAYRESTART restart succ");
//                        //     }
//                        //
//                        //     if(HCNetSDK.getInstance().NET_DVR_PlayBackControl_V40(m_iPlaybackID, PlaybackControlCommand
//                        // .NET_DVR_PLAYFAST, null, 0, struPlaybackInfo))
//                        //     {
//                        //    	 Log.e(TAG, "NET_DVR_PLAYFAST succ");
//                        //     }
//                        //     if(HCNetSDK.getInstance().NET_DVR_PlayBackControl_V40(m_iPlaybackID, PlaybackControlCommand
//                        // .NET_DVR_PLAYSLOW, null, 0, struPlaybackInfo))
//                        //     {
//                        //    	 Log.e(TAG, "NET_DVR_PLAYSLOW succ");
//                        //     }
//                        //
//                        //     if(HCNetSDK.getInstance().NET_DVR_PlayBackControl_V40(m_iPlaybackID, PlaybackControlCommand
//                        // .NET_DVR_PLAYSTARTAUDIO, null, 0, struPlaybackInfo))
//                        //     {
...
//                        thread.start();
//                    } else {
//                        Log.i(TAG, "NET_DVR_PlayBackByTime failed, error code: " + HCNetSDK.getInstance()
//                                .NET_DVR_GetLastError());
//                    }
//                } else {
...
//                        }
//
////                        HCNetSDK.getInstance().NET_DVR_PlayBackControl_V40(m_iPlaybackID, PlaybackControlCommand
//.NET_DVR_PLAYPAUSE, null, 0, struPlaybackInfo);
////                        Thread thread = new Thread()
////                		{
////                	   		public void run()
...
////                				}
////                	   			HCNetSDK.getInstance().NET_DVR_PlayBackControl_V40(m_iPlaybackID, PlaybackControlCommand
//.NET_DVR_PLAYRESTART, null, 0, null);
////                	   		}
////                	   	};
////                	   	thread.start();
////
...
////                        m_oPlaybackBtn.setText("Stop");
////
////                        int iPlaybackIndex = HCNetSDKJNAInstance.getInstance().NET_DVR_GetPlayBackPlayerIndex
//(m_iPlaybackID);
////                        if(iPlaybackIndex != -1){
...
//                                public void fStdDataCallback(int iRealHandle, int iDataType, byte[] pDataBuffer, int
//                                        iDataSize) {
//                                    DemoActivity.this.processRealData(1, iDataType, pDataBuffer, iDataSize, Player
//                                            .STREAM_REALTIME);
//                                }
//                            };
//                        }
...
//            ////                        if (i % 100 == 0)
//            ////                        {
//            ////                            Log.e(TAG, "inputData failed with: " + Player.getInstance().getLastError
//            /// (m_iPort) + ", i:" + i);
//            ////                        }
//            //
//            //                        try {
...
//            } else {
//                Demo = new DemoActivity();
//                new Thread(new Runnable() {                                        //inner class - new thread to get
//                    // device list
//                    @Override
//                    public void run() {
